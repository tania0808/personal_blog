				...
				<div class="flex justify-between">
					...
					<div id="dropdown" class="ms-6 z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
						<ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
							...
							<li>
								<a href="/posts/delete/<?php echo $post->getId(); ?>" class="block text-red-600 px-4 py-2 hover:bg-gray-100">Delete</a>
							</li>
						</ul>
					</div>
                    <?php endif; ?>
...
<section class="container px-5 pt-24 pb-6 mx-auto">
	<div class="lg:w-4/5 mx-auto flex flex-col">
		...
		<form class="mb-6 max-w-3xl" action="" method="post">
            ...
            <?php endif; ?>
			<button type="submit" class="mt-2 inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 hover:bg-blue-800">
				Post comment
			</button>
		</form>
		        ...
		        <footer class="flex justify-between items-center mb-2">
			        <div class="flex items-center">
				        <p class="inline-flex items-center mr-3 text-sm text-gray-900 font-semibold"><img
							        ...
							        alt="Michael Gough"><?php echo $commentAuthors[$comment->getAuthorId()]->getFullName() ?></p>
				        <p class="text-sm text-gray-600"><?php echo date("F jS, Y", strtotime($comment->getCreatedAt())); ?></p>
			        </div>
                    ...
                    <?php if ($comment->getAuthorId() === $currentUser): ?>
	                    <!-- Dropdown menu -->
	                    <div id="dropdownComment1"
		                    ...
		                    <ul class="py-1 text-sm text-gray-700"
			                    ...
			                    <li>
				                    <a href="/posts/<?php echo $post->getId(); ?>/comments/delete/<?php echo $comment->getId(); ?>" class="block text-red-600 px-4 py-2 hover:bg-gray-100">Delete</a>
			                    </li>
		                    </ul>
	                    </div>
                    <?php endif; ?>
