...
<a href="/post/create" class="text-white ml-4 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none ">Add new</a>
				...
				<div class="flex items-center justify-between">
					<div class="flex items-center flex-1">
						...
						<div class="flex flex-col mx-2">
							...
							<span class="text-xs text-gray-600"><?php echo date("F jS, Y", strtotime($post->getCreatedAt())); ?></span>
						</div>
					</div>
				</div>
			</section>
