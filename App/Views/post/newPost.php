...
<div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
    <form class="space-y-4 md:space-y-6" method="post" enctype="multipart/form-data">
            ...
            <label>
                <input
                        ...
                        class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm
                               rounded-lg focus:border-blue-500 focus:outline-none focus:ring block w-full p-2.5">
            </label>
        ...
        <button
                type="submit"
                class="w-fit mt-8 text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
            Add the post
        </button>
    </form>
</div>